...
export default function Pharmary() {
  const route = useRouter();
  const [fullname, setfullname] = useState("");
  const [speciality, setspeciality] = useState("Pharmacy");
  ...
  const [utype, setutype] = useState("Pharmacy");
  ...
  return (
    <View>
      <Stack.Screen
        options={{
          headerTitle: `${id != null ? `Edit Pharmacy Info` : `Add Pharmacy`}`,
        }}
      />
      <ScrollView>
